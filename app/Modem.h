...
struct ModemInfo {
  ...
  ModemInfo(const uint32_t vendorId,
            const uint32_t productId,
            const std::string & modemName,
            const enum ModemType modemType,
            const uint8_t atPort,
            const uint8_t dialPort,
            const uint8_t dbgPort,
