...
struct LocalDialParam {
    ...
    { OPERATOR_UNICOM, MODE_WCDMA,  "*99#",    "user", "user", "3gnet" },  /* WCDMA mode */
    { OPERATOR_MOBILE, MODE_TDSCDMA,"*98*1#",  "user", "user", "cmnet" },  /* TDSCDMA mode */
    { OPERATOR_MOBILE, MODE_TDLTE,  "*98*1#",  "card", "card", "cmnet" },  /* TDLTE mode */
    { OPERATOR_TELCOM, MODE_FDDLTE, "*99#",    "user", "user", "ctlte" },  /* FDDLTE mode */
    { OPERATOR_UNICOM, MODE_FDDLTE, "*98*1#",  "user", "user", "cuinet"},  /* FDDLTE mode */

    { OPERATOR_MOBILE, MODE_TDLTE,  "*98*1#",  "card", "card", "cmwap" },  /* TDLTE mode */
    { OPERATOR_MOBILE, MODE_TDLTE,  "*98*1#",  "card", "card", "cmmtm" },  /* TDLTE mode */

    { OPERATOR_TELCOM, MODE_EVDO,   "#777",    "ctnet@mycdma.cn", "vnet.mobi", ""},/*evdo mode */
    { OPERATOR_TELCOM, MODE_FDDLTE, "*98*1#",  "user", "user", "ctm2m" },  /* FDDLTE mode */
    { OPERATOR_TELCOM, MODE_FDDLTE, "*98*1#",  "user", "user", "ctnet" },  /* FDDLTE mode */
    { OPERATOR_TELCOM, MODE_FDDLTE, "*98*1#",  "user", "user", "ctwap" },  /* FDDLTE mode */

    { OPERATOR_UNICOM, MODE_FDDLTE, "*98*1#",  "user", "user", "uninet"},  /* FDDLTE mode */
    { OPERATOR_UNICOM, MODE_FDDLTE, "*98*1#",  "user", "user", "uniwap"},  /* FDDLTE mode */
    { OPERATOR_UNICOM, MODE_FDDLTE, "*98*1#",  "user", "user", "wonet" },  /* FDDLTE mode */
};
...
bool Dial::dialPPP(DialCb cb)
{
    ...
    char portStr[32] = { 0 };
    snprintf(portStr, sizeof(portStr) -1, 
        MODEM_TTY_USB_PREFIX, _modem->getModemInfo()->_dialPort);
