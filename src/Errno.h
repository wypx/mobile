...
enum MobileErrno {
  MOBILE_E_SUCCESS = 0,
  MOBILE_E_DRIVER_NOT_INSTALLED =
      1, /* Driver lsmod in /proc/moudules not installed */
  MOBILE_E_DRIVER_ID_NOT_FOUND = 2, /* Driver lsusb show id file not found*/
  MOBILE_E_DRIVER_ID_NOT_SUPPORT =
      3, /* Driver lsusb id not supported in apploacation */
  MOBILE_E_TTY_USB_NOT_FOUND = 4, /* ttyUSB not exist */
  MOBILE_E_TTY_USB_OPEN_FAIL = 5, /* ttyUSB AT intf open failed */
  MOBILE_E_TTY_USB_UNAVAILABLE =
      6, /* ttyUSB opened successful, but (AT+CGMM) blocked*/
  ...
  MOBILE_E_SIM_ABSENT =
      13,                /* fail to set the location where CDMA subscription
  ...
  MOBILE_E_OPERATOR_NOT_SUPPORT =
      18, /* Operator maybe not support by Modem, Band... */
  MOBILE_E_OPERATOR_RECOGNOSED = 19, /* Operator has been recognosed */
  MOBILE_E_OP_NOT_ALLOWED_DURING_VOICE_CALL =
      20, /* data ops are not allowed during voice
             call on a Class C GPRS device */
  MOBILE_E_OP_NOT_ALLOWED_BEFORE_REG_TO_NW =
      21,                            /* data ops are not allowed before device
                                        registers in network */
  MOBILE_E_SMS_SEND_FAIL_RETRY = 22, /* fail to send sms and need retry */
  MOBILE_E_MODE_NOT_SUPPORTED =
      23,                    /* HW does not support preferred network type */
  ...
  MOBILE_E_NETWORK_NOT_READY =
      28, /* Network is not ready to perform the request */
