...
class GetMobileAPNRequest final :
 ...
 public:
  ...
  ~GetMobileAPNRequest() override;
  explicit constexpr GetMobileAPNRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline GetMobileAPNRequest* New() const final {
    return new GetMobileAPNRequest();
  }
...
class GetMobileAPNResponse final :
 ...
 public:
  ...
  ~GetMobileAPNResponse() override;
  explicit constexpr GetMobileAPNResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline GetMobileAPNResponse* New() const final {
    return new GetMobileAPNResponse();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_apn();
...
void GetMobileAPNResponse::set_apn(ArgT0&& arg0, ArgT... args) {
